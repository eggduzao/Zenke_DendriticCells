...
# Coordinates
coordLocation = "/work/eg474423/ig440396_dendriticcells/exp/diffpeak/res/peaks/irf8_pu1/"
...
coordLabel2 = ["pDC_PU1-IRF8"]
coordList2 = ["pDC_PU1_m_IRF8.bed"]

# Gene Lists
geneLocation= "/work/eg474423/ig440396_dendriticcells/exp/diffpeak/expression/"
geneLabel1 = ["IRF8_IND", "IRF8_REP", "MPP_CDP", "CDP_MPP"]
geneList1 = ["gfp_up.txt", "gfp_down.txt", "mpp_cdp.txt", "cdp_mpp.txt"]
geneLabel2 = ["cDC_pDC", "pDC_cDC"]
geneList2 = ["cdc_pdc.txt", "pdc_cdc.txt"]
...
enrichCoordLabel = [coordLabel2]
enrichCoordList = [coordList2]
enrichGeneLabel = [geneLabel2]
enrichGeneList = [geneList2]
...
for i in range(0,len(enrichCoordLabel)):
  ...
  for c in range(0,len(coordLabel)):
    ...
    for g in range(0,len(geneLabel)):
      ...
      outLoc = "/work/eg474423/eg474423_Projects/trunk/DendriticCells/MotifStatistics/IRF8_PU1_10/"+coordLabel[c]+"__"+geneLabel[g]+"/"
      ...
      myL = coordLabel[c]+"_"+geneLabel[g]
      clusterCommand = "bsub "
      ...
      clusterCommand += coord_file+" "+gene_list+" "+pwm_dataset+" "+logo_location+" "
