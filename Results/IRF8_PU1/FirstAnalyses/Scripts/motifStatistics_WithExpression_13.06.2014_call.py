...
geneLabel1 = ["cdp_up","cdp_down"]
geneList1 = ["cdp_up.txt", "cdp_down.txt"]
geneLabel2 = ["pan_dc"]
geneList2 = ["pan_dc.txt"]
...
for i in range(0,len(enrichCoordLabel)):
  ...
  for c in range(0,len(coordLabel)):
    ...
    for g in range(0,len(geneLabel)):
      ...
      outLoc = "/work/eg474423/eg474423_Projects/trunk/DendriticCells/MotifStatistics/IRF8_PU1_WithExp_13.06.2014/"+coordLabel[c]+"__"+geneLabel[g]+"/"
      ...
      # Label: E = enrichment | Y = expression | 1306 = 13.06
      myL = "EY1306_"+coordLabel[c]+"_"+geneLabel[g]
      clusterCommand = "bsub "
