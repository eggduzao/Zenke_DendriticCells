...
# Coordinates
coordLocation = "/work/eg474423/eg474423_Projects/trunk/DendriticCells/IRF8_MotifStatistics_Scripts/Input/coord_ext_60/"
...
for i in range(0,len(enrichCoordLabel)):
  ...
  for c in range(0,len(coordLabel)):
    ...
    pwm_dataset="-pwm_dataset=/work/eg474423/eg474423_Projects/trunk/DendriticCells/IRF8_MotifStatistics_Scripts/Input/PWM_novel/"
    ...
    rand_proportion_size="-rand_proportion_size=1"
    all_coord_evidence="-all_coord_evidence=Y"

    outLoc = "/work/eg474423/eg474423_Projects/trunk/DendriticCells/MotifStatistics/IRF8_PU1_novelOnly/"+coordLabel[c]+"/"
    ...
    myL = coordLabel[c]
    clusterCommand = "bsub "
    clusterCommand += "-J "+myL+"_MSNO -o "+myL+"_MSNO_out.txt -e "+myL+"_MSNO_err.txt "
    clusterCommand += "-W 100:00 -M 12000 -S 100 -P izkf -R \"select[hpcwork]\" ./motifStatistics_pipeline.zsh "
